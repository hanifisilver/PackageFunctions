            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="text-danger">-3.65%</span> <span class="text-muted">Since last
                                        week</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="text-success">5.25%</span> <span class="text-muted">Since last
                                        week</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card <?= !isSuperUser() ? 'disabled' : '' ?>"
                                title="<?= !isSuperUser() ? 'Süper User olmanız gerekir' : '' ?>">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <span class="text-success">6.65%</span> <span class="text-muted">Since last
                                        week</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card <?= !isSuperUser() ? 'disabled' : '' ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <span class="text-danger">-2.25%</span> <span class="text-muted">Since last
                                        week</span>
                                </div>
                            </div>
                        </div>
